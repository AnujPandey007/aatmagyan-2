...
export default function Login({isAuth, setIsAuth, setAlert, setUserData}) {
 ...
 const login = async()=>{
  ...
  return (
    <div className={`container my-3`}>
      ...
      <button type="submit" className="btn btn-primary" disabled={loading} onClick={login}>Login</button>
    </div>
  )
}
